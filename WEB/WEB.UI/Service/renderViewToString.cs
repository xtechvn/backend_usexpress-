...
namespace WEB.UI.Service
{
    ...
    {
        public interface IRenderViewRenderService
        {
            Task<string> RenderToString(string viewName, object model);
        }
        public class ViewRenderServiceNew : IRenderViewRenderService
        {
            private readonly IRazorViewEngine _razorViewEngine;
            private readonly ITempDataProvider _tempDataProvider;
            private readonly IHttpContextAccessor _contextAccessor;

            public ViewRenderServiceNew(IRazorViewEngine razorViewEngine,
