...
namespace Payoo.Lib
{
    public class CmsCryptography //: System.Web.UI.Page
    {
        private X509Certificate2 _SignerCert, _RecipientCert;
        private Encoding _Enc = Encoding.UTF8;
        private readonly IHostingEnvironment _hostingEnvironment;

        public CmsCryptography(IHostingEnvironment hostingEnvironment)
        {
        ...
        public CmsCryptography()
        {
            ...
            LoadSignerCredential(webRootPath + (@"~/PayooLib/App_Data/Certificates/biz_pkcs12.p12"), "biz");
            RecipientPublicCertPath = webRootPath + (@"~/PayooLib/App_Data/Certificates/payoo_public_cert_sandbox.pem");
        }
